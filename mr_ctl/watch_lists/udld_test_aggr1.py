...
rt_vars_dict = {
    "comment": "Vars for testsuite ABC"
}
...
g_runtime_variables = g_rt_vars_file
...
if __name__== "__main__":
    ...
    open(g_rt_vars_file, "w").close()
    backup_rt_vars_file(g_rt_vars_file)
    with open(g_rt_vars_file, "w") as rt:
        json.dump(rt_vars_dict, rt, indent=4)
